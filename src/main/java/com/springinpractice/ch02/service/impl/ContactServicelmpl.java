...
import com.winter.word.WordApplication;

@Service
public class ContactServiceImpl implements ContactService {

	private final WordApplication wordApplication;
	...
	private static final String FIND_ALL_SQL = "select id, last_name, mi, email from contact";
	...
	public ContactServiceImpl(WordApplication wordApplication, NamedParameterJdbcOperations jdbcTemplate, ContactRowMapper contactRowMapper) {
