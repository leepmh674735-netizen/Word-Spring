...
<head>
    ...
    <title>Subscription Confirmed - Aggro's Towne BBS</title>
...
<body>
    ...
    <main class="container my-5" style="max-width: 600px;">
        <div class="glass-card text-center py-5">
            ...
            <h1 class="h3 text-white mb-3">Subscription Confirmed!</h1>
            <p class="text-light opacity-90 fs-5 mb-4">
                Your subscription to the Aggro's Towne mailing list has been successfully confirmed. Welcome to the loop!
            </p>
