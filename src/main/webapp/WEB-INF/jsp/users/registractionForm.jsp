...
<c:url var="registerPostUrl" value="/users" />
...
<head>
    ...
    <title>New User Registration - Aggro's Towne BBS</title>
    ...
    <main class="container my-5" style="max-width: 600px;">
        <div class="glass-card">
            <header class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 text-white mb-1"><i class="bi bi-person-plus-fill text-indigo me-2"></i>Create Account</h1>
                    <p class="text-muted small mb-0">Join the Aggro's Towne board community</p>
                </div>
                <a href="${homeUrl}" class="btn btn-outline-custom btn-sm"><i class="bi bi-arrow-left me-1"></i> Back</a>
            </header>

            <form:form action="${registerPostUrl}" modelAttribute="account" method="post">
                <form:errors path="*">
                    <div class="alert-custom-warning mb-3">
                        <i class="bi bi-exclamation-circle-fill me-2"></i> Form validation failed. Please check the fields below.
                    </div>
                </form:errors>

                <div class="mb-3">
                    <label for="username" class="form-label form-label-custom">Username</label>
                    <form:input path="username" id="username" class="form-control form-control-custom" placeholder="Choose a username" required="required" />
                    <form:errors path="username" class="text-danger small mt-1" />
                </div>
                
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="password" class="form-label form-label-custom">Password</label>
                        <form:password path="password" id="password" class="form-control form-control-custom" placeholder="Enter password" required="required" />
                        <form:errors path="password" class="text-danger small mt-1" />
                    </div>
                    <div class="col-md-6">
                        <label for="confirmPassoword" class="form-label form-label-custom">Confirm Password</label>
                        <form:password path="confirmPassoword" id="confirmPassoword" class="form-control form-control-custom" placeholder="Re-type password" required="required" />
                        <form:errors path="confirmPassoword" class="text-danger small mt-1" />
                    </div>
                </div>
                ...
                <div class="mb-3 form-check">
                    <form:checkbox path="marketingOK" id="marketingOK" class="form-check-input" />
                    <label class="form-check-label text-muted small" for="marketingOK">Please send me product updates by e-mail.</label>
                </div>

                <div class="mb-4 form-check">
                    <form:checkbox path="acceptTerms" id="acceptTerms" class="form-check-input" required="required" />
                    <label class="form-check-label text-muted small" for="acceptTerms">I accept the <a href="#" class="text-indigo">terms of use</a>.</label>
                </div>
                
                <div class="d-grid">
                    <button type="submit" class="btn btn-premium py-2.5"><i class="bi bi-person-check-fill me-2"></i>Register Account</button>
                </div>
            </form:form>
        </div>
    </main>
