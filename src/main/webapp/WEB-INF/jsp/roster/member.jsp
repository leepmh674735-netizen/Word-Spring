...
<head>
    ...
    <title>Member Details: <c:out value="${member}" /> - Aggro's Towne BBS</title>
...
<body>
    ...
    <main class="container my-5" style="max-width: 600px;">
        <div class="glass-card text-center py-5">
            <div class="avatar-glow mb-4 mx-auto d-flex align-items-center justify-content-center" style="width: 90px; height: 90px; border-radius: 50%; background: rgba(99, 102, 241, 0.15); border: 2px solid rgba(99, 102, 241, 0.3);">
                <i class="bi bi-person-badge-fill text-indigo fs-1"></i>
            </div>
            
            <h1 class="h3 text-white mb-2"><c:out value="${member}" /></h1>
            <p class="text-muted mb-4">Verified BBS Community Member</p>
            
            <hr class="border-secondary opacity-25 my-4" />
            
            <div class="d-flex justify-content-center gap-3">
                <a href="list" class="btn btn-outline-custom"><i class="bi bi-arrow-left me-2"></i>Back to Roster</a>
                <a href="${contactUrl}" class="btn btn-premium"><i class="bi bi-envelope-fill me-2"></i>Send Message</a>
            </div>
        </div>
    </main>
