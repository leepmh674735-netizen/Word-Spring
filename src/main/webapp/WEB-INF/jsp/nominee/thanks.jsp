...
<head>
    ...
    <title>Nomination Successful - Aggro's Towne BBS</title>
...
<body>
    ...
    <main class="container my-5" style="max-width: 600px;">
        <div class="glass-card text-center py-5">
            <div class="avatar-glow mb-4 mx-auto d-flex align-items-center justify-content-center" style="width: 80px; height: 80px; border-radius: 50%; background: rgba(16, 185, 129, 0.15); border: 2px solid rgba(16, 185, 129, 0.3);">
                <i class="bi bi-check-circle-fill text-success fs-1"></i>
            </div>
            
            <h1 class="h3 text-white mb-3">Nomination Received!</h1>
            <p class="text-light opacity-90 fs-5 mb-4">
                Thank you for nominating <strong class="text-indigo"><c:out value="${member}" /></strong> for the BBS Outstanding Member Award.
            </p>
            
            <hr class="border-secondary opacity-25 my-4" />
            
            <div class="d-flex justify-content-center gap-3">
                <a href="${homeUrl}" class="btn btn-outline-custom"><i class="bi bi-house-fill me-2"></i>Back Home</a>
                <a href="${nomineeUrl}" class="btn btn-premium"><i class="bi bi-plus-circle me-2"></i>Nominate Another</a>
            </div>
        </div>
    </main>
