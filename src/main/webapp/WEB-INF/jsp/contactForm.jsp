...
<c:url var="contactPostUrl" value="/contact" />
...
<head>
    ...
    <title>Contact Sysop - Aggro's Towne BBS</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom active" aria-current="page" href="${contactUrl}">Contact Us</a>
                    </li>
                </ul>
    ...
    <main class="container my-5" style="max-width: 600px;">
        <div class="glass-card">
            <header class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 text-white mb-1"><i class="bi bi-envelope-fill text-indigo me-2"></i>Contact Sysop</h1>
                    <p class="text-muted small mb-0">Send a direct transmission to the system operators</p>
                </div>
                <a href="${homeUrl}" class="btn btn-outline-custom btn-sm"><i class="bi bi-arrow-left me-1"></i> Back</a>
            </header>

            <form:form action="${contactPostUrl}" modelAttribute="userMessage" method="post">
                <form:errors path="*">
                ...
                <div class="mb-3">
                    <label for="name" class="form-label form-label-custom">Your Name</label>
                    <form:input path="name" id="name" class="form-control form-control-custom" placeholder="Enter your name" required="required" />
                    <form:errors path="name" class="text-danger small mt-1" />
                </div>
                ...
                <div class="mb-4">
                    <label for="text" class="form-label form-label-custom">Message Text</label>
                    <form:textarea path="text" id="text" class="form-control form-control-custom" rows="5" placeholder="Type your message here..." required="required" />
                    <form:errors path="text" class="text-danger small mt-1" />
                </div>
                
                <div class="d-grid">
                    <button type="submit" class="btn btn-premium py-2.5"><i class="bi bi-send-fill me-2"></i>Transmit Message</button>
                </div>
            </form:form>
        </div>
    </main>
